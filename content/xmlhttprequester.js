function lyrics_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
lyrics_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				lyrics_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
lyrics_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
lyrics_xmlhttpRequester.prototype.setupRequestEvent =
